...
SEED="42"
GPU_ID="0"
RUN_NAME="evaluate_quantized_bert${SEED}"
PJ_NAME="evaluate_quantized_bert_squad2"
...
CUDA_VISIBLE_DEVICES=$GPU_ID nohup python -u run_quantized_bert_squad.py --project $PJ_NAME \
--model_type bert \
--model_name_or_path /home/rohit/extractive_qa/bert_base_fine_tuned42 --do_lower_case \
